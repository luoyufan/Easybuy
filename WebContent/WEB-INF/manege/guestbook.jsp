...
<body>
	<div id="header" class="wrap">
		...
		<div class="help">
			<a href="${pageContext.request.contextPath }/index.html">返回前台页面</a>
		</div>
		<div class="navbar">
			<ul class="clearfix">
		...
		<div id="menu-mng" class="lefter">
			<div class="box">
				<dl>
					...
					<dt>留言管理</dt>
					<dd>
						<a href="CommentsServlet?method=login">留言管理</a>
					</dd>
					<dt>新闻管理</dt>
					<dd>
				...
				<table class="list">
					...
					<c:if test="${not empty requestScope.comments}">
						<c:forEach items="${requestScope.comments}" var="comment" varStatus="status">
							<tr>
								<td class="first w4 c"><c:out value="${status.count }"/></td>
								<td class="w1 c"><c:out value="${ comment.EC_NICK_NAME}"/></td>
								<td><c:out value="${comment.EC_CONTENT}"/></td>
								<td class="w1 c">已回复</td>
								<td class="w1 c"><a href="CommentsServlet?method=reply">回复</a>
									<a href="CommentsServlet?method=delete&id=${comment.EC_ID}"
	...
	<div id="footer">Copyright &copy; 2017 蜗牛学院 All Rights Reserved.
		京ICP证1000001号</div>
</body>
</html>